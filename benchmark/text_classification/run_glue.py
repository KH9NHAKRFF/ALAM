...
import time
import alam
from alam.utils import get_memory_usage, exp_recorder
...
def parse_args():
    ...
    parser.add_argument("--alam", action="store_true", help="Whether or not to use alam")
    ...
    if args.alam:
        assert args.gradient_accumulation_steps == 1, "alam works with accumulation step = 1"
...
def main():
    ...
    # prepare alam
    if args.alam:
        alam.set_config(bit=args.bit, total_step=args.max_train_steps)
